...
/**
 * Plugin Name: Filemaker Reader
 * Plugin URI: http://www.domain.tld
 * Plugin Prefix: filemaker_reader
 * Plugin ID: filemaker-reader
 * Description: Interface to read the filemaker api
 * Version: 1.0.0
 * Author: jminguely
 * Author URI: https://framework.themosis.com/
 * Text Domain: filemaker-reader
 * Domain Path: languages
 * Domain Var: FILEMAKER_MDA
